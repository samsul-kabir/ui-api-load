...
Ext.define('TestApp.view.FilterGridPanel', {
    extend: 'Ext.grid.Panel',
    alias :'widget.browserInfoPanel',
	title : 'Browser Info',
	closable: true,
    ...
    buildFields:function(){ // creamos la definicion de los slots, es decir qeu propiedades tienen
        var fields = [
            ...
            {name: 'browser',           type: 'string', defaultValue: undefined},
            {name: 'platform',          type: 'string', defaultValue: undefined},
            {name: 'engine_version',    type: 'float',  defaultValue: undefined},
            {name: 'css_grade',         type: 'string', defaultValue: undefined}
        ];
