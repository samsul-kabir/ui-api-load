...
@Slf4j
public class ConvertToSlack {

	public void sendReportToSlack(String cucumerReportPath, String webhookPath, String jenkinsReportPath) throws FileNotFoundException {
		log.info("Converting to slack report");
		...
		//String jenkinsReportPath = "http://testlink.com";
		...
		String requestAttachment = "{\n" + "    \"attachments\": [\n" + "        {\n"
				...
				+ "            \"title\": \"Test report overview\",\n" + "            \"title_link\": \"" + jenkinsReportPath
				+ "\",\n" + "            \"text\": \"Optional text that appears within the attachment\",\n"
				+ "            \"fields\": [\n" + "                {\n"
				+ "                    \"title\": \"Feature\",\n" + "                    \"value\": \"Total feature: "
				+ featureLength + " \\n:white_check_mark: Passed: " + (featureLength - failedFeatureSize)
				+ "   :o: Failed: " + failedFeatureSize + "\",\n" + "                    \"short\": true\n"
				+ "                },\n" + "				{\n"
				+ "                    \"title\": \"Failed Feature\",\n" + "                    \"value\": \""
				+ convertListToString(failedFeature) + "\",\n" + "                    \"short\": true\n"
				+ "                },\n" + "				{\n" + "                    \"title\": \"\",\n"
				+ "                    \"value\": \"\",\n" + "                    \"short\": false\n"
				+ "                },\n" + "				{\n" + "                    \"title\": \"\",\n"
				+ "                    \"value\": \"\",\n" + "                    \"short\": false\n"
				...
				+ " \\n:white_check_mark: Passed: " + (scenarioLength - failedScenarioSize) + "   :o: Failed: "
				+ failedScenarioSize + "\",\n" + "                    \"short\": true\n" + "                },\n"
				...
				+ "                    \"short\": false\n" + "                },\n" + "				{\n"
				+ "                    \"title\": \"Steps\",\n" + "                    \"value\": \"Total steps: "
				+ totalSteps + " \\n:white_check_mark: Passed: " + (totalSteps - failedStepsSize) + "   :o: Failed: "
				+ failedStepsSize + "\",\n" + "                    \"short\": true\n" + "                },\n"
				+ "				{\n" + "                    \"title\": \"Failed Steps\",\n"
				...
				+ convertListToString(pathToFailedSteps) + "\",\n" + "                    \"short\": false\n"
				+ "                }\n" + "            ],\n"
		...
		/*
		 * System.out.println("Feature"); System.out.println("Total feature: " +
		 * featureLength + " Passed: " + (featureLength - failedFeatureSize) +
		 * "  Failed: " + failedFeatureSize); System.out.println("Failed Feature: " +
		 * convertListToString(failedFeature));
		 * 
		 * System.out.println(""); System.out.println("Scenario");
		 * System.out.println("Total Scenario: " + scenarioLength + " Passed: " +
		 * (scenarioLength - failedScenarioSize) + "  Failed: " + failedScenarioSize);
		 * System.out.println("Failed Scenario: " +
		 * convertListToString(failedScenario));
		 * 
		 * System.out.println(""); System.out.println("Steps");
		 * System.out.println("Total steps: " + totalSteps + " Passed: " + (totalSteps -
		 * failedStepsSize) + "  Failed: " + failedStepsSize);
		 * System.out.println("Failed steps: " + convertListToString(failedSteps));
		 * 
		 * System.out.println(""); System.out.println("Paths to failed steps:");
		 * System.out.println("Path: " + convertListToString(pathToFailedSteps));
		 */
	}

	public String convertListToString(ArrayList<String> messageList) {
		String msg = "";
